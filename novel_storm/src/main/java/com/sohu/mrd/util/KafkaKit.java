...
public class KafkaKit {
	private static final Logger LOG = LoggerFactory.getLogger(KafkaKit.class);
	...
	private static Properties getConsumerProperties(final String groupId)
	{
	 ...
	 */
	public static void  consumerMessage(final String groupId,final String topic,Integer threadNum,final LinkedBlockingQueue<String> queue)
	{
...
//						 }
	...
	public static void main(String[] args) {
		...
		kit.sendMessage(KafkaConstant.FORMATE_USER_BEHAVIOR_TOPIC, "test_test_test");
		//com_sohu_mrd_text_classification_sexy_ads_logs_
		//kit.consumerMessage("com_sohu_mrd_online_docId_sexy_ads_logs_consumer", "com_sohu_mrd_online_docId_sexy_ads_logs", 3, queue);
		
		//kit.consumerMessage("testn_test_pan1238", "com_sohu_mrd_text_classification_sexy_ads_logs_", 3, queue);
		
		 
		
		kit.consumerMessage("testn_te333st_pan12380000", "com_sohu_mrd_user_behavior_novel_2", 3, queue);
