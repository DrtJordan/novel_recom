    ...
    public static void login(Map conf, Configuration hdfsConfig) throws IOException {
        if (UserGroupInformation.isSecurityEnabled()) {
             ...
             */
                ...
                try {
                    UserGroupInformation.loginUserFromKeytab("mrd/10.10.21.71@HERACLES.SOHUNO.COM", "/mnt/mrd/mrd.keytab");
                } catch (IOException e) {
                    e.printStackTrace();
                }

//            String keytab="mrd.keytab_10.10.21.71";
//           // String keytab = (String) conf.get(STORM_KEYTAB_FILE_KEY);
//            if (keytab != null) {
//              hdfsConfig.set(STORM_KEYTAB_FILE_KEY, keytab);
//            }
//            String userName = "mrd/_HOST@HERACLES.SOHUNO.COM";
